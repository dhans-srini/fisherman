...
public class AdminService {
	...
	private final String allFormQuery = "select id,code,type,name,biometric_id, fathers_name, is_married,section,created_on,status "
	...
	public User validateUser(String userName, String password) throws BusinessException {
		try {
			...
			if (!user.getIsActive()) {
				throw new BusinessException("Your accout is deactivated! Please contact admin.");
			}
